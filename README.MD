...
<ngx-zxing
    ...
    [cameraAutofocusEnabled]="cameraAutofocusEnabled"
...
- `cameraAutofocusEnabled` can be used to enable or disable the autofocus-feature of the camera (defaults to `true`)
